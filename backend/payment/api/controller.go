...
import (
	...
	app "github.com/basetable/basetable/backend/payment/application"
	"github.com/basetable/basetable/backend/payment/domain"
	hutil "github.com/basetable/basetable/backend/shared/api/httputil"
...
func NewPaymentController(paymentService app.PaymentService, paymentGateway app.PaymentGateway, logger log.Logger) PaymentController {
