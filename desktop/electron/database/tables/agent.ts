...
export const agent = sqliteTable("agent", {
  ...
  uploaded_status: text({ enum: ['downloaded', 'local', 'uploaded', 'require_update'] }).default('local'), // Status of the agent upload. Require_update means that the agent has been updated locally and needs to be re-uploaded.
  name: text().notNull(),
